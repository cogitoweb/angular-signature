...
angular.module('signature').directive('signaturePad', ['$window', '$timeout',
	function ($window, $timeout) {
		...
		return {
			restrict: 'EA',
			replace: true,
			template: '<div class="signature" ng-style="{height: height + \'px\', width: width + \'px\'}"><canvas ng-mouseup="updateModel()" style="width: 70vw !important; height: 60vh !important;"></canvas></div>',
			scope: {
				accept: '=',
				clear: '=',
				dataurl: '=',
